...
public class PZKSVariant8QueuePlanner extends PZKSQueuePlanner
{
	public PZKSVariant8QueuePlanner(PZKSGraph graph)
	{
		super(graph);
	}
	...
	public Queue<PZKSQueueElement> getQueue() 
	{
		...
		int[] criticalPathes = PZKSParametersCalculator.getCriticalNK(getGraph(),false);
